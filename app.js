...
function toggleHeader() {
    if (window.pageYOffset > 60 && header.classList.contains('max-header')) {
        ...
        menu.classList.remove('max-menu')
        menu.classList.add('min-menu')
        text.classList.remove('max-text')
        text.classList.add('min-text')
        ...
        menu.classList.add('max-menu')
        text.classList.remove('min-text')
        text.classList.add('max-text')
    }
}
